...
const SuperAdminSetup = ({ onSetupComplete }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error.code === 'auth/email-already-in-use') {
        ...
        setError('Failed to create super admin account. Please try again.');
      }
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center px-4">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Initial Setup</h1>
          <p className="text-gray-600 mt-2">Create your Super Admin account</p>
